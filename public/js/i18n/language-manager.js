class LanguageManager {
  ...
  async loadTranslations() {
    try {
      // Improved error handling and path construction
      ...
      // More robust extraction of JSON from module
      let jsonText = text
      if (text.includes("export default")) {
        jsonText = text.replace(/const \w+ = /, "").replace(/;[\s\n]*export default \w+;?/, "")
      }
      ...
      try {
        ...
        // Create a fallback object with basic translations
        this.translations = {
          common: {
            welcome: "Welcome",
